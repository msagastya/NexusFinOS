...
export function buildTransferTransactions(input: TransferInput): TransferResult {
  const { fromAccountId, toAccountId, amount, currency, timestamp, description } =
    input;
 ...
 */
export function validateTransfers(transactions: Transaction[]): boolean {
